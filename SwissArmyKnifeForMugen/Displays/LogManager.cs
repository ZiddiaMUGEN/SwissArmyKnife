...
{
    /// <summary>
    /// Both handler for logging in SAK, and a log window to show log data directly.
    /// </summary>
    public class LogManager : Form
    {
        ...
        /// <summary>
        /// Logs to file only with newline.
        /// </summary>
        ...
        /// <summary>
        /// Logs to file only without newline.
        /// </summary>
        /// <param name="msg">Message to log</param>
        ...
        /// <summary>
        /// Logs both to window and to file, if possible, with newline.
        /// </summary>
        /// <param name="msg">Message to log</param>
        ...
        /// <summary>
        /// Logs both to window and to file, if possible, without newline.
        /// </summary>
        /// <param name="msg">Message to log</param>
        ...
        /// <summary>
        /// Dumps info about all players to log. Used in panics.
        /// </summary>
        /// <param name="playerCount">number of players</param>
        /// <param name="playerId">list of player IDs</param>
        /// <param name="helperId">list of helper IDs</param>
        /// <param name="stateno">list of StateNo values</param>
        /// <param name="prevstateno">list of PrevStateNo values</param>
        /// <param name="name">list of character names</param>
